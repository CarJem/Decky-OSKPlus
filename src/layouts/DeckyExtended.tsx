...
export function generateLayout(): Array<KeyMapping>
{
    ...
    let keyList: Array<Array<any>> = [
        ...
        [
            ...
            [{ key: "Deckyboard_Reserved1", label: reserved_icon }],
        ...
        [
            ...
            [{ key: "Deckyboard_Reserved2", label: reserved_icon }],
            ...
            [{ key: "Deckyboard_Reserved3", label: reserved_icon }, { key: "Deckyboard_NumpadSubtract", label: "-" }],
        ...
        [
            ...
            [{ key: "Deckyboard_Reserved4", label: reserved_icon }, { key: "Deckyboard_NumpadAdd", label: "+" }],
